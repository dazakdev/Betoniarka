...
public class ReviewService {
  ...
  public ReviewResponseDto getReviewById(Long id) throws ResourceNotFoundException {
    ...
    return reviewRepo
        ...
        .map(mapper::toDto)
        .orElseThrow(
            () -> new ResourceNotFoundException("Review with id '%d' not found".formatted(id)));
  }
   ...
   */
  public ReviewResponseDto updateReviewById(Long id, ReviewUpdateDto dto)
      throws ResourceNotFoundException {

    Review existingReview =
        reviewRepo
            .findById(id)
            .orElseThrow(() -> new ResourceNotFoundException("Review with id '%d' not found"));
   ...
   *
   * <p>The review is removed both from the database and from the user's review collection to keep
   ...
   */
  public void deleteReviewById(Long id) throws ResourceNotFoundException, IllegalStateException {
